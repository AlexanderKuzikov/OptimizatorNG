...
export function setPageMargins(xmlString: string, params: { width: number; height: number; top: number; right: number; bottom: number; left: number; gutter: number; }): StepResult {
